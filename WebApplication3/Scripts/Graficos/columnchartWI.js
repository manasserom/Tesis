...
function drawBasic() {
    ...
    var aux = "" + document.getElementById('piechartDataWI').getAttribute('value');
    var aux2 = "" + document.getElementById('piechartCateWI').getAttribute('value');
    var cr = aux.split(",");
    var ca = aux2.split(",");
    //Valores para agregar
    var wTipo = $("#CriptoW").val();
